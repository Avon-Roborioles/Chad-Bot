"use strict";
const errors = {
    invalidType(param, requiredType, receivedObject) {
        const receivedType = Array.isArray(receivedObject) ? 'array' : typeof receivedObject;
        const message = `${param} must be ${receivedType == 'array' || receivedType == 'object' ? 'an' : 'a'} ${requiredType}. ` +
    ...
    connection: {
        ...
        connectionFailure: 'A connection error has occured. ' +
